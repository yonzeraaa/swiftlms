...
export function generateCSPHeader(nonce: string, isAPI = false): string {
  if (isAPI) {
    ...
    return [
      ...
      "img-src 'self' data:",
      "font-src 'self'",
      "connect-src 'self' https://mdzgnktlsmkjecdbermo.supabase.co wss://mdzgnktlsmkjecdbermo.supabase.co https://docs.google.com",
  ...
  return [
    ...
    "img-src 'self' data: https://mdzgnktlsmkjecdbermo.supabase.co blob: https:",
